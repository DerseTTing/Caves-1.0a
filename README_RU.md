...
![bossAttake](MediaFiles/boss.gif)
...
Если вы хотите сразиться с финальным боссом без поисков и заморочек, используйте тестовую версию игры, где вы сразу начинаете рядом с ареной битвы. Открывается тестовая версия точно так же, как и основная. Zip-файл тестовой версии с названием `Caves.BossTest.0.12.zip`.
